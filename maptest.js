...
console.log(Path.resolve("/u07/app/prod/apm/streaming_stat_parser/renders", "someimage.png"));
...
// function lookupPidsByRelativeScriptPath() {
...
// lookupPidsByRelativeScriptPath();
...
// ALERTSCONFIG.grafanaURL = "https://xlla9583.citacx.acxiom.com:3000";
...
// const alert = new AlertEntry(new Date().getTime(), new Date().getTime() + 5000, 'xcla9571', 'getSalesServiceOffers', 'cause1,cause2', 'field1|field2|field3');
